...
# Form implementation generated from reading ui file 'D:\桌面\python\PyQt5\QSS\注册界面搭建\resource\UI\login.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.login_bottom.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.widget_3.setStyleSheet("backgroud-color: rgb(85, 255, 127);")
        ...
        self.account_cb.setBaseSize(QtCore.QSize(0, 0))
...
"    width:20px;\n"
"}\n"
"QComboBox QAbstractItemViev:item{\n"
"    color:lightblue;\n"
"}")
        ...
        self.pwd_le.setMinimumSize(QtCore.QSize(0, 34))
...
"}")
        ...
        self.pushButton_2.setStyleSheet("border-image: url(:/login/images/qq.jpg);")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "注册界面"))
